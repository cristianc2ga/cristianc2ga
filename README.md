...
Mi nombre es Cristian Camilo Garcia Alarcon soy ingeniero electrónico y desarrollador web Full Stack especializado en Javascript y Python. Actualmente trabajo como procesador de datos sísmicos en el Instituto Colombiano del Petróleo. Por otro lado, soy lider técnico del semillero de Backend - Django y también soy desarrollador en una startup llamada timebli las dos anteriores en IncubApp Venture Capital.
